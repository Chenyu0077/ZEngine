...
namespace ZEngine.Editor
{
    public class ZEngineTools
    {
        ...
        {
            string batPath = $"{UnityEngine.Application.dataPath}/Datas/DataTables/gen.bat";
        ...
        [MenuItem(toolPath + "/UGUI MVC Generator", false, 30)]
        public static void ShowWindow()
        {
            EditorWindow.GetWindow<UGUIMVCGenerator>("UGUI MVC 生成器");
        }
