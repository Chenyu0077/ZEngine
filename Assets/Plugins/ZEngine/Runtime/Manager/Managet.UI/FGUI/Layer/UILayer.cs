...
namespace ZEngine.Manager.UI
{
    public static class UILayer
    {
        ...
        public static void Initialize()
        {
            ...
            var layers = new GComponent[]
            {
                Background_Compt, Bottom_Compt, Middle_Compt,
                Top_Compt, Window_Compt, Guide_Compt, Max_Compt
            };
            foreach (var layer in layers)
            {
                layer.SetSize(gRoot.width, gRoot.height);
                layer.AddRelation(gRoot, RelationType.Size);
