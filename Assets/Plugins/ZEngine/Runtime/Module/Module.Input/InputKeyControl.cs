    ...
    public class InputKeyControl
    {
        ...
        public bool GetKeyDown()
        {
            if (this.Key != Key.None)
            {
                ...
                if (k != null && InputManager.GetKeyDown(this.Key, k))
                    return true;
            }
            ...
            {
                Mouse m = GetMouse();
                if (m != null && InputManager.GetKeyDown(this.MouseButton, m))
                    return true;
            }
            ...
            if (this.isEnableGamepad)
            {
                ...
                if (g != null && InputManager.GetKeyDown(this.GamepadButton, g))
                    return true;
            }
        ...
        public bool GetKey()
        {
            if (this.Key != Key.None)
            {
                ...
                if (k != null && InputManager.GetKey(this.Key, k))
                    return true;
            }
            ...
            {
                Mouse m = GetMouse();
                if (m != null && InputManager.GetKey(this.MouseButton, m))
                    return true;
            }
            ...
            {
                Gamepad g = GetGamepad();
                if (g != null && InputManager.GetKey(this.GamepadButton, g))
                    return true;
            }
        ...
        public bool GetKeyUp()
        {
            if (this.Key != Key.None)
            {
                ...
                if (k != null && InputManager.GetKeyUp(this.Key, k))
                    return true;
            }
            ...
            {
                Mouse m = GetMouse();
                if (m != null && InputManager.GetKeyUp(this.MouseButton, m))
                    return true;
            }
            ...
            {
                Gamepad g = GetGamepad();
                if (g != null && InputManager.GetKeyUp(this.GamepadButton, g))
                    return true;
            }
